                    ...
                    while ($rows = mysqli_fetch_array($food)) {
                        ...
                        <div class="food-item-wrap">
                            ...
                            <div class="content">
                                ...
                                <div class="price-btn-block justify-content-between"> 
                                    <span class="price">Rs.' . $rows['price'] . '</span> 
                                    <a id="toggle_model" href="dishes.php?res_id=' . $rows['d_id'] . '" class="btn btn-primary btn-sm btn-outline-primary text-right view_prod" data-toggle="modal" data-id="#exampleModalCenter"><i class="fa fa-eye"></i> View</a>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    ...
    <div class="MODEL">
        <div class="modal-header">
            ...
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <svg class="svg-inline--fa fa-arrow-right fa-w-16 t" aria-hidden="true" focusable="false" data-prefix="fa" data-icon="arrow-righ" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="">
                    <g>
                ...
                </svg><!-- <span class="fa fa-arrow-right"></span> -->
            </button>
        </div>
        <div class="card">
            <img src="admin\Res_img\dishes\5ad759e1546fc.jpg" class="card-img-top" alt="...">
            <div class="card-body">
