                ...
                <div class="top-links">
                    <div class="container">
                        <ul class="row links">
                            ...
                            <li class="col-xs-12 col-sm-4 link-item"><span>1</span><a href="index.php">Choose Food Category</a></li>
                                                    ...
                                                    <ul class=" list-unstyled">
                                                        <li>
                                                            <label class="custom-control custom-radio  m-b-20">
                                                                ...
                                                                <br> <span> you can able Pay digitally with SMS Pay Link.</span> </label>
                                                        </li>
                                                        <li>
