...
if(isset($_POST['submit']))
	...
	{
		if(empty($_POST['d_name'])||empty($_POST['about'])||$_POST['price']==''||$_POST['fd_category']=='')
		{
				...
				$fname = $_FILES['file']['name'];
					...
					if($extension == 'jpg'||$extension == 'png'||$extension == 'gif' )
					{
									if($fsize>=1000000)
										...
										{
												$sql = "INSERT INTO food(c_id,title,slogan,price,img) VALUE('".$_POST['fd_category']."','".$_POST['d_name']."','".$_POST['about']."','".$_POST['price']."','".$fnew."')";  // store the submited data ino the database :images
												mysqli_query($db, $sql);
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="form-group">
                                                    <!-- <label class="control-label">Select Restaurant</label> -->
																										...
																										<select name="fd_category" class="form-control custom-select" data-placeholder="Choose a Category" tabindex="1">
