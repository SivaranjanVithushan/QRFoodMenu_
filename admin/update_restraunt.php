...
if(isset($_POST['submit']))           //if upload btn is pressed
{
		...
		{
            $c_name=$_POST['ct_name'];

			$sql = "update food_category set c_name='$c_name' where c_id='$_GET[res_upd]' ";  // store the submited data ino the database :images												mysqli_query($db, $sql);
			mysqli_query($db, $sql);
        ...
        <div class="page-wrapper" style="height:1200px;">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Update Food Category Info</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Options</a></li>
                        <li class="breadcrumb-item active"> Food_Category</li>
                    </ol>
                </div>
            </div>
            <!-- End Bread crumb -->
            ...
            <div class="container-fluid">
                ...
                <div class="col-lg-12">
                    <div class="card card-outline-primary">
                        ...
                        <h4 class="m-b-0 ">Update Food Category</h4>

                        <div class="card-body">
                            <form action='' method='post' enctype="multipart/form-data">
                                <div class="form-body">
                                    <?php $ssql ="select * from food_category where c_id='$_GET[res_upd]'";
                                    ...
                                    <div class="row p-t-20">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="ct_name" value="<?php echo $row['c_name']; ?>"
                                                    class="form-control" placeholder="Koththu">
                                            </div>
                                        </div>
                                        <!--/span-->
                                    </div>
